...
import { UserPlus, ShieldCheck, LogIn } from 'lucide-react'; // Or use 'react-icons' if preferred
    ...
    >
      ...
      <div className="border-t pt-5 mt-6">
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 w-full bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2.5 rounded-xl shadow hover:shadow-md transition-all duration-300"
        >
          <LogIn size={20} />
          User Login
        </button>
